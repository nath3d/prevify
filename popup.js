...
function lightMode() {
    darkModeBtn.innerHTML =
        ...
        + '<path fill-rule="evenodd" clip-rule="evenodd" d="M18.299 15.581C17.4142 15.8534 16.4742 16 15.5 16C10.2533 16 6 11.7467 6 6.50002C6 4.043 6.93276 1.80383 8.4635 0.117311C3.67009 0.85649 0 4.99965 0 10C0 15.5228 4.47715 20 10 20C13.4562 20 16.5028 18.2467 18.299 15.581Z" fill="#9FB7A2"/>'
        + '</svg>'
    let styleToChange = {
        bg: '#FFFFFF', /*FFFFFF*/
        btnBg: '#EEF5F0', /*F8F5FF*/
        headerColor: '#000000', /*000000*/
        formText: '#000000', /*000000*/
        btnColor: '#1ED760', /*6116FF*/
        btnBorder: '#067123' /*24008C*/
    }
    switchProperties(styleToChange)
}
